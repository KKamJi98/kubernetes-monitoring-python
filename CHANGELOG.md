...
* improve UI with English localization, status styling, and layout enhancements ([763cc70](https://github.com/KKamJi98/kubernetes-monitoring-python/commit/763cc7023d04ce7871530fe0efc81b37504a63b4))


### Bug Fixes

* resolve CI ruff format failure and upgrade ruff to &gt;=0.14.0 ([0ee19ea](https://github.com/KKamJi98/kubernetes-monitoring-python/commit/0ee19eaf96b66f767151b81f30b0c933df2e940c))
